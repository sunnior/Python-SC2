...
static PyObject* cmap_tool_init(PyObject* self, PyObject* args)
{
	...
	PyArrayObject* ridge_np = (PyArrayObject*)PyArray_SimpleNew(2, walkable_object->dimensions, NPY_UINT8);
	PyArrayObject* region_np = (PyArrayObject*)PyArray_ZEROS(2, walkable_object->dimensions, NPY_UINT16, 0);
...
*/
	...
	PyList_SetItem(return_val, 0, PyArray_Return(distance_np));
	PyList_SetItem(return_val, 1, PyArray_Return(ridge_np));
	PyList_SetItem(return_val, 2, PyArray_Return(region_np));
